// Mirror of tailwind.config.js tokens for Chart.js (which needs JS color strings, not CSS classes).
// If a token hex changes, change it here too — this is the ONE place.
